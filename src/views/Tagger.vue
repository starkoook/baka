...
.tagger-preview { position: relative; flex: 1; min-height: 0; display: grid; place-items: center; overflow: hidden; border-radius: 14px; background: radial-gradient(circle at center,#201d24,#121116 72%); }
...
@media (max-width: 760px) {
  ...
  .tagger-toolbar__status small, .tagger-toolbar__model, .tagger-toolbar__actions .quiet { display: none; }
}
</style>
