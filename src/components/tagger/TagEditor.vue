...
.tag-chips { display: flex; flex-wrap: wrap; gap: 5px; }.tag-chips button { display: flex; align-items: center; gap: 4px; padding: 5px 6px 5px 8px; border: 1px solid rgba(255,255,255,.07); border-radius: 999px; background: rgba(255,255,255,.025); color: var(--text-secondary); cursor: pointer; font-size: 8px; }.tag-chips small { color: var(--text-tertiary); font-size: 6px; }.tag-chips i { color: var(--text-tertiary); font-style: normal; }
